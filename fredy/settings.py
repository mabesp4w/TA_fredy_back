"""
Django settings for fredy project.
...
SECRET_KEY = 'django-insecure-r2r_!w7h#znrirx$qh+%+&52hygj(o*z1zc%&d#6$z05v!fs6g'
...
WSGI_APPLICATION = 'fredy.wsgi.application'
...
# Lokasi folder tempat file statis disimpan selama development
STATICFILES_DIRS = [
...
# Email Configuration
# Untuk development, gunakan console backend (email akan ditampilkan di console)
# Untuk production, gunakan SMTP backend dengan konfigurasi berikut:
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@birddb.org')
